#Script for creating MovieDB
#By Benny Feng
#To run script press lightning bolt
#If gives you error to select schema, comment out 'Create Database MovieDB' Line and 
#refresh schema list on left and pick moviedb, then run again
